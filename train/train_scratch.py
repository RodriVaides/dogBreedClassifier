...
def train(n_epochs, loaders, model, optimizer, criterion, device, model_dir):
    ...
    for epoch in range(1, n_epochs+1):
        ...
        # Display the validation loss for this epoch if it has decreased
        ...
        # In my case I decided to save the model for all epochs, even if the validation loss did not decrease
